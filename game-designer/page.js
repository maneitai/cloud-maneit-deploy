(function () {
  ...
  function renderLog(type, actionLabel) {
    ...
    if (type === "saved") {
      ...
      executionSummary.textContent = "Design notes were saved without starting a production pass.";
      return;
    }
  ...
  runStageBtn.addEventListener("click", () => {
    renderLog("success", "Run selected pass");
  });

  saveWorkspaceBtn.addEventListener("click", () => {
    renderLog("saved", "Save design notes");
  });
